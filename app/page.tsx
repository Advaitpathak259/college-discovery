    ...
    <div className='min-h-screen w-full bg-[#FDFBF7] text-stone-900 flex flex-col overflow-hidden antialiased bg-[radial-gradient(#F3EDE0_1px,transparent_1px)] [background-size:24px_24px]'>
      ...
      <main className='flex-1 flex flex-col items-center pt-16 pb-20 text-center px-4 max-w-5xl mx-auto w-full z-0'>
        ...
        <motion.h1
          ...
          className='text-4xl md:text-6xl font-sans font-normal tracking-tight text-stone-950 max-w-3xl leading-[1.15]'
        >
        ...
        >
          {/* Wrapped in a smooth glass container to elevate the primitive UI look */}
          <div className="p-1.5 bg-white/80 border border-stone-200/60 rounded-2xl shadow-md backdrop-blur-md">
            <SearchBar />
          </div>
        </motion.div>
